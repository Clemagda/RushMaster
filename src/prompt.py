...
#
from slowfast_llava.llava.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from slowfast_llava.llava.conversation import conv_templates, SeparatorStyle
...
def get_prompt(model, conv_mode, question):
    if conv_mode == "image_seq_v3":
        ...
        if model.config.mm_use_im_start_end:
            ques = DEFAULT_IM_START_TOKEN + DEFAULT_IMAGE_TOKEN + \

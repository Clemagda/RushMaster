...
sys.path.insert(0, os.path.join(
    Path(__file__).parent.as_posix(), "slowfast_llava"))
...
def parse_args():
    ...
    parser.add_argument(
        "--model_path", help="LLaVA model path", type=str, required=True)
    parser.add_argument(
        "--question", help="Input question and prompt", type=str, required=True)
    parser.add_argument("--conv_mode", type=str,
                        required=False, default="image_seq_v3")
    ...
    parser.add_argument("--temporal_aggregation", type=str,
                        default="slowfast-slow_10frms_spatial_1d_max_pool-fast_4x4")
